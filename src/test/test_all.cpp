 ...
 * - test_peer_message.cpp          - Peer message protocol tests (11 tests, some removed)
 ...
 *
 * Total tests reduced (transaction/block/blockweave/blockfile tests using old constructors removed)
 *
...
void ShowUsage(const char* program_name) {
    ...
    std::cout << "  - test_peer_message.cpp          (Peer message protocol - 11 tests)\n";
