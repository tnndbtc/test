...
#ifdef _WIN32
    // Windows: Process is already detached by bweave_cli via CREATE_NO_WINDOW
    // Just write PID file for tracking
...
bool CDaemon::WritePidFile(const std::string& str_pid_file) {
    // Write PID file for both Windows and POSIX
